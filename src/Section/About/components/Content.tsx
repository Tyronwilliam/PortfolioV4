  ...
  return (
    <Fade cascade duration={300}>
      ...
      <div className="main_div">
        <div className="yellow_band"></div>
        <p>
          <strong>Mon aventure</strong> a débuté par l'acquisition des bases, et
          s'est ensuite enrichie par une formation approfondie à la 3WAcademy,
          où j'ai maîtrisé des technologies telles que React, JavaScript,
      ...
      <div className="main_div">
        ...
        <div>
          ...
          <p>
            <strong>Cette soif</strong> d'apprentissage m'a valu une expérience
            professionnelle enrichissante au sein d'une start-up dynamique,
            ainsi que <strong>plusieurs contrats fructueux</strong> en tant que
            freelance.
          </p>
        </div>
      </div>
      <div className="main_div">
        ...
        <p>
          ...
          web qui allient <strong>esthétisme et fonctionnalité</strong>, offrant
          ainsi une <strong>expérience utilisateur optimale</strong>.
        </p>
      </div>
      <div className="main_div">
        <div className="yellow_band"></div>
        <div>
          <p>
            En tant que <strong>professionnel du développement web</strong>, je
            m'engage à <strong>accompagner mes clients</strong> de A à Z dans le
            processus de création de leur site.
          </p>
          <p>
      ...
      <div className="main_div">
        ...
        <p>
          ...
          <strong>réalité digitale</strong>, en créant des sites web qui allient
          performance, élégance et <strong>facilité d'utilisation</strong>.
        </p>
      </div>
      <div className="main_div">
        <div className="yellow_band"></div>
